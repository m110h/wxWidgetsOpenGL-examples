...
MyFrame::MyFrame(const wxString& title): wxFrame(NULL, wxID_ANY, title, wxDefaultPosition, wxSize(500, 400))
{
    ...
    fileMenu->Append(Pyramid_LogW, "&Log window\tCtrl+l", "Open the log window");
    fileMenu->AppendSeparator();
    fileMenu->Append(Pyramid_Quit, "E&xit\tCtrl+w", "Quit this program");
    ...
    CreateStatusBar(2);
    SetStatusText("wxWidgets OpenGL examples: Pyramid");
...
bool MyGLCanvas::OglCtxAvailable()
{
